...
{
    public partial class NameAddress : Form
    {
        public NameAddress()
        {
            InitializeComponent();
        ...
        private void NameAddress_Load(object sender, EventArgs e)
        {
            ...
            string wkid = RecordSelected.selid;
            contactsBindingSource.Filter = "ID = " + wkid;
